    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/home">
                ...
                <div class="sidebar-brand-text mx-3">SENA <sup></sup></div>
            </a>
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        @if(Auth::user()->role=="Admin")
                            <a class="collapse-item" href="/ambiente">Ambientes</a>
                        @endif
            ...
            <li class="nav-item">
                ...
                <div id="collapseThree" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Seleccione:</h6>
                        <a class="collapse-item" href="/reporte/pre_crear">Crear reporte</a>
                        <a class="collapse-item" href="/reporte">Ver reporte</a>
                    </div>
                </div>
            </li>
